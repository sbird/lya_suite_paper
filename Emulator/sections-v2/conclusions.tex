...
When removing the lowest redshift bins from the analysis, we find, for a primeval power spectrum with a pivot scale of \maf{$0.78$ 1/Mpc}:
\begin{itemize}
...
\maf{add discussion of priors around here}
