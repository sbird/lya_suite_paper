...
\maf{removed reference to $\Omega_M h^2$ as growth function}
% (which is also the growth function during matter domination).
...
\begin{table}
  ...
  \hline
    ...
    \maf{The column labelled `Avg' is the average $\chi^2$ per degree of freedom for the redshift bins in the fit (i.e., excluding $z=2.2$ and $z=2.4$ for the last two chains).}
