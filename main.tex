...
The thermal history is measured by comparing simulations to observed statistics of high resolution quasar spectra, such as the flux power spectrum on scales $0.01$ - $0.1$ s/km. In future work we will investigate making direct constraints on our model via this statistic, rather than through the derived thermal history.
