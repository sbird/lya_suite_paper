...
\begin{figure*}
\includegraphics[width=1.\textwidth]{figures/cddf_hires.pdf}
...
\includegraphics[width=1.\textwidth]{figures/comp-temps_fq.pdf}
 \caption{Temperature variations for different resolutions.}
...
\begin{figure}
    \centering
	\includegraphics[width=0.31\columnwidth]{figures/single_param_hub.pdf}
    \includegraphics[width=0.31\columnwidth]{figures/single_param_omegamh2.pdf}
	\includegraphics[width=0.31\columnwidth]{figures/single_param_bhfeedback.pdf}
