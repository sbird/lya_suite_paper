...
\begin{centering}
  ...
  Parameter & Minimum & Maximum & Description \\
    ...
    \hline
  \end{tabular}
  \caption{Summary of varied emulator parameters, together with the ranges covered by the emulator. We vary a total of $9$ parameters: $4$ for cosmology, $3$ for the helium reionization model, $1$ for the hydrogen reionization model and $1$ for the strength of AGN feedback. \maf{could drop figure 1, or add description column to figure 1 caption and drop this table}}
